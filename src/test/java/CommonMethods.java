...
public class CommonMethods {
    ...
    public static void take_Page_Screenshot(RemoteWebDriver driver, String fileName) throws IOException {
        TakesScreenshot scrShot=(TakesScreenshot)driver;
        File scrFile=scrShot.getScreenshotAs(OutputType.FILE);
        FileHandler.copy(scrFile, new File("./src/main/resources/Screenshots/"+fileName+".png"));
    }

    //selenium4 method to get screenshot of an element
    public static void take_element_Screenshot(RemoteWebDriver driver, By findBy, String fileName) throws IOException {
        WebElement element=driver.findElement(findBy);
        File scrElement=element.getScreenshotAs(OutputType.FILE);
        FileHandler.copy(scrElement,new File("./src/main/resources/Screenshots/element_"+fileName+".png"));
    }

    //selenium4 alternate method to get screenshot of an element
    public static void take_element_Screenshot_alternate(RemoteWebDriver driver, By findBy, String fileName) throws IOException {
        WebElement element=driver.findElement(findBy);
        TakesScreenshot scrShot=(TakesScreenshot)element;
        File scrFile=scrShot.getScreenshotAs(OutputType.FILE);
        FileHandler.copy(scrFile, new File("./src/main/resources/Screenshots/element_alternate_"+fileName+".png"));
    }
}
